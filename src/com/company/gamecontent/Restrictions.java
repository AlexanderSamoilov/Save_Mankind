...
public abstract class Restrictions {
    ...
    private static final int INTERSECTION_STRATEGY_SEVERITY = 1;
    ...
    private static final int MAX_X = java.lang.Math.min(MONITOR_MAX_X, MONITOR_MAX_Y) / BLOCK_SIZE;
    private static final int MAX_Y = java.lang.Math.min(MONITOR_MAX_X, MONITOR_MAX_Y) / BLOCK_SIZE;
    private static final int MAX_Z = 16;

    private static final int MAX_OBJECT_SIZE_BLOCKS = 3;

    private static final int MAX_MASS = 1000;
    ...
    private static final int MAX_RESOURCES_TYPES = 2;
    ...
    public static int getMaxObjectSizeBlocks() { return java.lang.Math.min(MAX_OBJECT_SIZE_BLOCKS, java.lang.Math.min(MAX_X, MAX_Y)); }
    ...
    public static int getMaxResourcesTypes() { return MAX_RESOURCES_TYPES; }
    ...
    public static int getMaxDetectRadiusAbs() { return java.lang.Math.max(getMaxXAbs(), getMaxYAbs()) / 2; }
