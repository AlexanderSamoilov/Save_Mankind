...
public class Point3D_Integer extends Cortege3D_Integer {
    ...
    public Point3D_Integer(Integer [] v) { super(v); }
     ...
     */
    public Point3D_Integer(Cortege3D_Integer p) { super(p); }
    ...
    public Point3D_Integer plus(Cortege3D_Integer v) { return super.plus(v); }
    public Point3D_Integer minus(Cortege3D_Integer v) { return super.minus(v); }
    public Point3D_Integer mult(Number K) { return super.mult(K); }
    public Point3D_Integer divInt(Number K) { return super.div(K); }

    // Unary operators returning new object
    public Point3D_Integer plus1(Vector3D_Integer v) { return super.plus1(v); }
    public Point3D_Double plus1(Vector3D_Double v) { return super.plus1(v); }
    public Point3D_Integer minus1(Vector3D_Integer v) { return super.minus1(v); }
    public Point3D_Double minus1(Vector3D_Double v) { return super.minus1(v); }
    public Vector3D_Integer minus1(Point3D_Integer v) { return new Vector3D_Integer(this).minus(v); }
    public Vector3D_Double minus1(Point3D_Double v) { return new Vector3D_Double(this).minus(v); }
    public Point3D_Integer mult1(Integer K) { return super.mult1(K); }
    ...
    // Binary operators
    public static Point3D_Integer plus2(Point3D_Integer p, Vector3D_Integer v) { return Cortege3D_Integer.plus2(p, v); }
    public static Point3D_Double plus2(Point3D_Integer p, Vector3D_Double v) { return Cortege3D_Integer.plus2(p, v); }
    public static Point3D_Integer minus2(Point3D_Integer p, Vector3D_Integer v) { return Cortege3D_Integer.minus2(p, v); }
    public static Point3D_Double minus2(Point3D_Integer p, Vector3D_Double v) { return Cortege3D_Integer.minus2(p, v); }
    public static Vector3D_Integer minus2(Point3D_Integer p1, Point3D_Integer p2) {
        return new Vector3D_Integer(p1).minus(p2);
    }
    public static Vector3D_Double minus2(Point3D_Integer p1, Point3D_Double p2) {
        return new Vector3D_Double(p1).minus(p2);
    }
    public static Point3D_Integer mult2(Point3D_Integer p, Integer K) { return Cortege3D_Integer.mult2(p, K); }
    public static Point3D_Double mult2(Point3D_Integer p, Double K) { return Cortege3D_Integer.mult2(p, K); }
    public static Point3D_Double div2(Point3D_Integer p, Integer K) { return Cortege3D_Integer.div2(p, K); }
    public static Point3D_Double div2(Point3D_Integer p, Double K) { return Cortege3D_Integer.div2(p, K); }
    public static Point3D_Integer divInt2(Point3D_Integer p, Number K) { return Cortege3D_Integer.divInt2(p, K); }
