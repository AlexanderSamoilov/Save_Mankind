...
public class ParallelogramHorizontal extends Figure_2D /*implements Centerable*/ {
    ...
    public void render(Graphics g) {
        ...
        g.drawLine(loc.x(), loc.y(), loc.x() + width - 1, loc.y());
        g.drawLine(loc.x() + width - 1, loc.y(), loc.x() + shift + width - 1, loc.y() + height - 1);
        g.drawLine(loc.x() + shift + width - 1, loc.y() + height - 1, loc.x() + shift, loc.y() + height - 1);
        g.drawLine(loc.x() + shift, loc.y() + height - 1, loc.x(), loc.y());
